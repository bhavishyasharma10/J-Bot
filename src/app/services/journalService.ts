...
class JournalService {
    static async saveHighlight(from: string, highlight: string): Promise<void> {
        try {
            ...
            await connection.promise().execute(query, [from, highlight]);
    ...
    static async saveThought(from: string, thought: string): Promise<void> {
        try {
            ...
            await connection.promise().execute(query, [from, thought]);
    ...
    static async saveIdea(from: string, idea: string): Promise<void> {
        try {
            ...
            await connection.promise().execute(query, [from, idea]);
    ...
    static async saveAffirmation(from: string, affirmation: string): Promise<void> {
        try {
            ...
            await connection.promise().execute(query, [from, affirmation]);
    ...
    static async saveGratitude(from: string, gratitude: string): Promise<void> {
        try {
            ...
            await connection.promise().execute(query, [from, gratitude]);
    ...
    static async saveReflection(from: string, reflection: string): Promise<void> {
        try {
            ...
            await connection.promise().execute(query, [from, reflection]);
        ...
        try {
            switch (command.action) {
                case 'add':
                    ...
                    await connection.promise().execute(addQuery, [from, command.category, command.content]);
                ...
                case 'complete':
                    ...
                    const [result] = await connection.promise().execute(completeQuery, [from, command.category]);
                ...
                case 'list':
                    ...
                    const [todos] = await connection.promise().execute(listQuery, [from, command.category]);
